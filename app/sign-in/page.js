...
export default function SignIn() {
  ...
  return (
    <main style={{
      ...
      <div className="comet" style={{top:"30%",left:"60%",animationDuration:"3.5s",animationDelay:"2s"}}></div>
      ...
      <div className="login-card" style={{
        ...
        <div style={{textAlign:"center",marginBottom:36}}>
          ...
          <h1 style={{fontFamily:"'Bricolage Grotesque',sans-serif",fontSize:"1.8rem",fontWeight:800,color:"white",marginBottom:8}}>Welcome Back 👋</h1>
          <p style={{color:"rgba(255,255,255,0.4)",fontSize:14}}>Sign in to continue learning</p>
        </div>
        ...
        <input className="input-modern" type="password" placeholder="Password" value={form.password} onChange={e => setForm({...form,password:e.target.value})} onKeyDown={handleKey} />
        ...
        <div style={{textAlign:"center",padding:"16px 0",borderTop:"1px solid rgba(255,255,255,0.06)",color:"rgba(255,255,255,0.4)",fontSize:14}}>
          ...
          <a href="/sign-up" style={{color:"#f59e0b",fontWeight:700,textDecoration:"none"}}>Create one free →</a>
        </div>
      </div>
    </main>
  )
