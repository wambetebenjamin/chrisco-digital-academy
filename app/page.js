...
export default function Home() {
 ...
 {item} <span className="dot" style={{ width: 8, height: 8, background: "var(--lime)", borderRadius: "50%", display: "inline-block", border: "2px solid #fff" }}></span>
 </span>
 ))}
 </div>
 ))}
